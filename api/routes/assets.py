...
async def create_asset(
    asset: AssetCreate, current_user: User = Depends(get_current_active_user)
):
    """
    Create a new asset.
    """
...
async def add_vulnerability_to_asset(
    ...
    return {
        "status": "success",
        "message": f"Vulnerability '{vulnerability}' added to asset {asset_id}",
    }
...
async def remove_vulnerability_from_asset(
    ...
    result = await asset_service.remove_vulnerability_from_asset(
    ...
    return {
        "status": "success",
        "message": f"Vulnerability '{vulnerability}' removed from asset {asset_id}",
    }
...
async def remove_tag_from_asset(
    ...
    return {
        "status": "success",
        "message": f"Tag '{tag}' removed from asset {asset_id}",
    }
...
async def update_asset_last_seen(
    ...
    return {
        "status": "success",
        "message": f"Updated last seen timestamp for asset {asset_id}",
    }
